      ...
      <div class="form">
        ...
        <form @submit="submit">
          <label for="firstName">First Name ${
            state.form.firstName.length ? 'is ' + state.form.firstName : ''
          }</label>
          <input type="text" model="state.form.firstName" placeholder="Your name..">
      
          <label for="lastName">Last Name ${
            state.form.lastName.length ? 'is ' + state.form.lastName : ''
          }</label>
          <input type="text" model="state.form.lastName" placeholder="Your last name..">
      
          ${
            state.form.firstName.length && state.form.lastName.length
          ...
          <input type="submit" value="Submit" ${
            state.form.firstName.length && state.form.lastName.length ? '' : 'hidden'
          }>
        </form>
      </div>
    `;
